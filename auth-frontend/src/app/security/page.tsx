...
export default function SecurityPage() {
  ...
  return (
    <div className="auth-shell security-shell">
      <div className="security-card">
        <div className="brand"><div className="brand-mark">B</div><div><strong>BifrostNMS</strong><div className="muted">Account security</div></div></div>
